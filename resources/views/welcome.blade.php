    ...
    <body class="antialiased">
        ...
        <div class="sm:text-center lg:text-left">
          <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
            <span class="block text-gray-200 xl:inline">La tua Biblioteca</span>
            <span class="block text-indigo-600 xl:inline">Sempre Online</span>
          </h1>
          <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
            Arricchisci le tue conoscenze con la nostra fornitura di libri completamente gratuiti.
          </p>
