...
<div class=" min-h-screen mt-10 flex items-center px-4 ">
        ...
        <div class="mx-auto">
            <a class="my-5 py-2 px-4   bg-gray-600 hover:bg-gray-700 focus:ring-gray-500 focus:ring-offset-indigo-200  text-white  transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg " href="../" ">Indietro</a>
